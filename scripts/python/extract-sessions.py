...
def main():
    ...
    parser.add_argument(
        '--add',
        help='Comma-separated fields to add to default set'
    )
    
    parser.add_argument(
        '--remove',
        help='Comma-separated fields to remove from default set'
    )
    
    parser.add_argument(
        '--only',
        help='Comma-separated fields to extract (ignores defaults)'
    )
    ...
    parser.add_argument(
        '--show-defaults',
        action='store_true',
        help='Show default field set and exit'
    )
    
    parser.add_argument(
        '--stats-only',
        action='store_true',
        help='Show statistics without extracting data'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help='Number of sample records to show in dry-run (default: 5)'
    )
